...
public class WalletConfigCustomRepositoryImpl implements WalletConfigCustomRepository {
    ...
    public boolean updateDeleteFlag(long pointConfigId) {
        String query = "UPDATE WalletConfig p SET p.delFlg = 1 WHERE p.id = :pointConfigId AND p.delFlg != 1";
